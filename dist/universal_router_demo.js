...
var pathToRegexp = _interopDefault(__webpack_require__(15));
...
var _universalRouter = __webpack_require__(25);
...
var route = [{
  ...
  action: function action() {
    return _react2.default.createElement(
      'div',
      null,
      _react2.default.createElement(LinkList, null),
  ...
  children: [{
    ...
    action: function action(context) {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(LinkList, null),
        _react2.default.createElement('hr', null),
        _react2.default.createElement(Topics, { params: context.parmas })
      );
    }
  }, {
    path: '/:topicID',
    action: function action(context) {
      return _react2.default.createElement(Topic, { params: context.params });
    }
  }]
}];
...
var Topics = function Topics(props) {
  return _react2.default.createElement(
    'div',
    null,
    props.params ? _react2.default.createElement(
      'div',
      null,
      'topic:'
    ) : _react2.default.createElement(
...
var router = new _universalRouter2.default(route);

function render(location) {
  router.resolve({ path: location.pathname }).then(function (component) {
...
var Link = function (_React$Component) {
  ...
  _createClass(Link, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'a',
        { href: this.props.to, onClick: this.clickHandler },
        this.props.children
      );
    }
  }]);
